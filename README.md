...
- **[CDX](https://cdx.ae)** — Digital asset on/off-ramp infrastructure
- **[Multipolitan](https://multipolitan.com)** — Cross-border global mobility platform
- **[Savea](https://savea.com)** — Tokenized real-world asset investment infrastructure
- **[DESAT](https://desat.org)** — Physical asset tokenization protocol · Reference implementation of EIP-7578
...
- AI-enabled systems in regulated environments
